...
The main area holds the input fields where we can enter text based content. Regular posts will have fields for *title* and *content*, but additional fields (excerpt and custom fields) can be activated from the admin settings.
